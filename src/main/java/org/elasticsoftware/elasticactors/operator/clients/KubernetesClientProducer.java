...
import static org.elasticsoftware.elasticactors.operator.env.Environment.OPERATOR_NAMESPACE;
import static org.elasticsoftware.elasticactors.operator.util.StringUtils.isEmpty;
...
public class KubernetesClientProducer {
    ...
    public static final String CRD_GROUP = "elasticactors.io";
    public static final String CRD_NAME = "actorsystems." + CRD_GROUP;
    public static final String CRD_VERSION = "v1";
    public static final String CR_KIND = ActorSystem.class.getSimpleName();
